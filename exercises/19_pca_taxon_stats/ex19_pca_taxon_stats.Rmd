...
knitr::opts_knit$set(root.dir = '/xdisk/bhurwitz/bh_class/YOUR_NETID/exercises/19_pca_taxon_stats') # Change your NETID
```
...
```{bash, engine.opts='-l'}
# R library png requires a newer version of libpng than we have installed on the operating system on our nodes, and updated font
# This will help us to get our beautiful figures below.
export LD_LIBRARY_PATH=/opt/ohpc/pub/apps/libpng/1.6.37/lib:$LD_LIBRARY_PATH
export FONTCONFIG_PATH=/etc/fonts
```
