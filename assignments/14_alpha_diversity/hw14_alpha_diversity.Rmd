...
Now, Let's compute the observed richness and label each sample with it.
...
fmt %>% 
  ps_calc_diversity(rank = 'Genus', index = 'shannon') %>%
  samdat_tbl() %>% 
  ggplot(aes(x = shannon_Genus, y = "FMT samples over time")) + 
...
It looks like the recipient fmt have lower gut microbiota diversity on average.
